...
def build_action_call(result: AnalysisResult) -> ActionCall | None:
...
def format_action_call(result: AnalysisResult) -> str:
...
def action_call_to_dict(result: AnalysisResult) -> dict | None:
    action_call = build_action_call(result)
    if action_call is None:
        return None
